...
public class ManufacturerPersistenceTests {
	...
	public void testTrueFalse() throws Exception {
		List<Manufacturer> man = manufacturerJpaRepository.findByActiveTrue();
		assertEquals("Fender Musical Instruments Corporation", man.get(0).getName());

		man = manufacturerJpaRepository.findByActiveFalse();
		assertEquals("Gibson Guitar Corporation", man.get(0).getName());
	}
